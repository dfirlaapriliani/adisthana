<x-layout-admin>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-[#2C1810]" style="font-family: 'Cormorant Garamond', serif;">Tambah Kategori</h1>
        <p class="text-[#9a8a80] text-sm mt-1">Tambahkan kategori baru untuk buku</p>
    </div>
        ...
        <form action="{{ route('admin.kategori.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" required
                    placeholder="Contoh: Novel, Pelajaran, Ensiklopedia"
                ...
                <p class="text-xs text-[#9a8a80] mt-1">Slug akan otomatis dibuat dari nama kategori</p>
                @error('nama')
